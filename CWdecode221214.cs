...
namespace CWExpert
{
    public class CWDecode
    {
        ...
        public double thld0 = 2;
//       public double thld1 = 128;
        public const int aver = 10;
        public int bwl0 = 5;
        public int bwh0 = 15;
        public int bwl1 = 5 + FFTlen;
        public int bwh1 = 15 + FFTlen;
        ...
        public string[] scp = new string[43260];
...
//                    Debug.WriteLine(line + " " + counter.ToString() + "  " + noises.ToString());
        ...
        private void cqcqcq()
        {
            if (MainForm.so2r)
                MainForm.Invoke(new CrossThreadCallback(CrossThreadCommand), "TXexch", "");
            tx_timer = txdots("CQ ") + txdots(mycall);
